      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col-reverse md:flex-row items-center">
          <div className="w-full md:w-1/2 mt-8 md:mt-0 md:pl-12 text-left">
            <RevealOnScroll>
              <h1 className="font-playfair text-4xl md:text-5xl lg:text-6xl font-extrabold text-black mb-4 tracking-tight leading-tight">
                Dr. Wanjiru Kareithi
              </h1>
            </RevealOnScroll>
            <RevealOnScroll delay={350}>
              <div className="mb-4">
                <span className="font-playfair text-xl md:text-2xl text-black font-semibold tracking-tight fast-script transition-all">{displayed}<span className="blinking-cursor">|</span></span>
              </div>
            </RevealOnScroll>
